...
implements GoogleMap.OnMapLongClickListener, GoogleMap.OnMarkerClickListener, GoogleMap.OnInfoWindowClickListener {
	...
	public void onInfoWindowClick(Marker mark) {
		...
		if (msg != null) {
			...
			intent.putExtra(MessageActivity.KEY_FILE_URI, msg.getFileUri());
	...
	private void setMessages(List<ParseObject> list) {
		...
		for (ParseObject parseMsg : list) {
			ParseGeoPoint geo = parseMsg.getParseGeoPoint("location");
			mNearbyMessages.put(parseMsg.getObjectId(),
					new Message(parseMsg.getString("title"), parseMsg.getString("message"),
